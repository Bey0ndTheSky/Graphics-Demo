...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
    ...
    sceneMeshes.emplace_back(Mesh::LoadFromMeshFile("low_poly_door_03.msh"));
...
void Renderer::DrawShadowScene() {
    ...
    Matrix4 viewMatrix = Matrix4::BuildViewMatrix(light->GetPosition(), Vector3(0, 0, 0));
    Matrix4 projMatrix = Matrix4::Perspective(1, 100, 1, 45);
