...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
    ...
    edgeShader = new Shader("TexturedVertex.glsl", "edgeFilterPostProcessFrag.glsl");

    if (!processShader->LoadSuccess() || !sceneShader->LoadSuccess() || !edgeShader->LoadSuccess() || !heightTexture) {
        return;
    }
...
void Renderer::DrawPostProcessSobel() {
    ...
    BindShader(edgeShader);
    UpdateShaderMatrices();
    glUniform1i(glGetUniformLocation(edgeShader->GetProgram(), "sceneTex"), 0);
